...
let stripe = require("stripe")(
  "sk_test_51J4rHMFpIjqeQSowkMeG3KxDKxCEwxE3blfu4dkDdZz7IJzs1Q8eCeYyCOisQApnafc2BS3ie9B2fjaTJl3MDPgv00hjUyYC2B"
);
...
exports.orderRecentGetController = async (req, res, next) => {
  let recentOrders = await Order.find().sort({ _id: -1 }).limit(5);
...
exports.orderPostUpdateController = async (req, res, next) => {
  ...
  await Order.findOneAndUpdate(
    ...
    {
      $set: {
        paymentStatus: updateStatus.payment,
        orderStatus: updateStatus.order,
        orderTimeline: createOrderTimeline(updateStatus.order, preTime),
      },
    }
  );
